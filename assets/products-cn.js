const productCn = {
  ...
  "CF-004": ["多肉育苗块 3.7 cm", "适用于多肉繁殖、小型装饰盆和零售种植套装。"],
  ...
  "CF-128": ["组培育苗块 3.7 cm", "适用于组培生根、整齐幼苗和高密度育苗盘。"],
  "CF-072": ["72 穴育苗块 4.0 cm", "适用于蔬菜、花卉和商业育苗。"],
  "CF-200": ["高密度育苗块 2.8 cm", "适用于植物工厂和高密度育苗系统。"],
  "CF-005": ["方形水培育苗块 5.0 cm", "适用于方形定植孔、家庭水培和零售育苗套装。"],
  "CF-003": ["家庭育苗块 3.7 cm", "适用于家庭播种、补充装和入门育苗套装。"],
  "CF-006": ["方形育苗块 4.0 cm", "适用于方形穴盘和常规育苗。"],
  "CF-901": ["多肉种植球 20 cm", "适用于多肉展示、悬挂和特色种植项目。"],
  "CF-902": ["多肉种植球 16 cm", "适用于中型多肉展示和零售种植产品。"],
  "CF-903": ["多肉种植球 11 cm", "适用于小型多肉展示、礼品套装和特色花器。"],
  "CF-129": ["圆柱形育苗块 3.1 cm", "适用于扦插、播种和圆柱形穴孔。"],
  "CF-067": ["多肉种植杯 6.7 cm", "适用于多肉种植、装饰花器和家庭园艺套装。"],
  "CF-010": ["通用育苗块 4.1 cm", "适用于播种、扦插和不同穴盘的前期测试。"],
  "CF-015": ["兰花育苗块 4.5 cm", "适用于兰花育苗和分阶段换盆。"],
  "ZY-060": ["蝴蝶兰育苗块（双规格）", "提供两种目录规格，取样前需确认所选尺寸和穴盘匹配。"],
  "ZY-2735": ["紧凑型组培基质块 3.5 cm", "适用于组培苗过渡和紧凑型育苗盘。"],
  "X-090": ["低矮型种植杯 6.8 cm", "适用于容器种植、换盆和特色育苗项目。"],
...
async function loadChineseProducts() {
  ...
  function card(product) {
    ...
    const tags = (product.applicationTags || []).map((tag) => `<span>${tag}</span>`).join("");
  ...
  function render() {
    ...
    compareBody.innerHTML = items.map((product) => {
      ...
      return `<tr><td><strong>${product.model}</strong></td><td>${localized[0]}</td><td>${product.size}</td><td>${product.trayFit}</td><td>${(product.applicationTags || []).join(" / ")}</td></tr>`;
    }).join("");
  }
